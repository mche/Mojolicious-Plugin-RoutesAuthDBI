...
=item * B<auth> - hashref options pass to base plugin L<Mojolicious::Plugin::Authentication>. By default the option:
...
=item * B<admin> - hashref options for special admin controller. This controller has subs and methods for manage auth and access operations, will appling routes from sql-table. See L<Mojolicious::Plugin::RoutesAuthDBI::Admin>
