...
The config attr B<dbh> - DBI connection where are tables: routes, users, groups, rels.
...
=item * Table of users groups

    create table groups(...);

=item * Table of relations between routes, users and groups
